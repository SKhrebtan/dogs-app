  ...
  return (
    <div className="w-screen h-[50px]">
          ...
          >
            ...
            <ul className="flex flex-col gap-6 items-start pl-[60px] pt-[40px]">
              <div className="flex flex-col gap-6 mb-[60px]">
                ...
                {user?.role === "user" && (
                  <Link onClick={handleMenu} href="/mydogs">
                    <li
                      className={`${
                        pathname === `/${language}/mydogs`
                          ? "text-2xl text-blue-500 underline underline-offset-8"
                          : "text-2xl"
                      } `}
                    >
                      ...
                      <li
                        className={`${
                          pathname === `/${language}/login`
                            ? "text-xl text-blue-500 underline underline-offset-8"
                            : "text-xl"
                        } `}
                      >
                        Login
      ...
      <div className="fixed z-40 flex flex-row w-screen justify-end p-[10px] bg-blue-300">
        <BurgerSvg onClick={handleMenu} className="fill-yellow-500" />
      </div>
    </div>
  );
}
